...
OUT_IDATA = ROOT / "results" / "tme_ou_ecotype_idata_E88_FINAL.nc"
...
with pm.Model(coords=coords) as ou_ecotype_model:
    ...
    # ------------------------------------------------------------
    print("[INFO] Sampling posterior predictive observations...")
    ...
    print("[INFO] Posterior predictive groups now available:", idata.groups)
